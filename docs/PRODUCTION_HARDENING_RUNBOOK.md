...
| [`Wael9912/odoo-nile-theme`](https://github.com/Wael9912/odoo-nile-theme) | `v18.0.2.1.0` | `/mnt/nile-theme` | the `nile_*` theme stack (1 theme module + brand packs) |
...
git clone -b v18.0.2.1.0 https://github.com/Wael9912/odoo-nile-theme.git
# Existing DB upgrade: -u nile_theme,nile_brand_medsupply --i18n-overwrite, then restart Odoo (see DEPLOY_PINS.md).
