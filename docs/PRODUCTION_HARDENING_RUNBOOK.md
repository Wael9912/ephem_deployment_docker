...
| [`Wael9912/odoo-nile-theme`](https://github.com/Wael9912/odoo-nile-theme) | `v18.0.1.1.1` | `/mnt/nile-theme` | the `nile_*` theme stack |
...
git clone -b v18.0.1.1.1 https://github.com/Wael9912/odoo-nile-theme.git
