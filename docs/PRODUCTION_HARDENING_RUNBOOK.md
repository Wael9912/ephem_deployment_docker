...
| [`Wael9912/odoo-nile-theme`](https://github.com/Wael9912/odoo-nile-theme) | `v18.0.2.5.1` | `/mnt/nile-theme` | the `nile_*` theme stack (1 theme module + brand packs) |
...
git clone -b v18.0.2.5.1 https://github.com/Wael9912/odoo-nile-theme.git
# Existing DB upgrade: -u nile_theme,nile_brand_medsupply, then restart Odoo (see DEPLOY_PINS.md).
