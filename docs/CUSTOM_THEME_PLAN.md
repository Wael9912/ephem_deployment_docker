...
**Total: ~36 person-days.** Phases 0–4 are DONE (`18.0` @ `v18.0.1.1.1` + tour/19.0 docs @ `28c97b2`) — the ONLY remaining plan item is the deferred Phase-1 doc re-capture (manual + both decks), ON HOLD until the user asks.
