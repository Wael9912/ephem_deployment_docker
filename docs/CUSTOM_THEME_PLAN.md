...
**Total: ~36 person-days.** Phases 0–4 are DONE (`18.0` @ `v18.0.1.2.0`) — the ONLY remaining plan item is the deferred Phase-1 doc re-capture (manual + both decks), ON HOLD until the user asks.
